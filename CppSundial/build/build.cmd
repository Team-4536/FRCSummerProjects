...
:: build src
g++ -c src/utils.cpp -Iexternal -Isrc -o out/utils.o -g
...
g++ out/base.o out/network.o out/blue.o out/utils.o out/main.o out/graphics.o out/stb_image.o out/stb_truetype.o out/gl.o -Lexternal\glfw -lglfw3 -lopengl32 -lkernel32 -luser32 -lgdi32 -lws2_32 -o out/sun -g
